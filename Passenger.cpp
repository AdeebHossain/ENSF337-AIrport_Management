...
/* Constructor */
Passenger::Passenger(): FName("\0"), LName("\0"), PhoneNum("\0"), PSeat(nullptr), PID(0) {}; //INCLUDE SEAT
...
void Passenger::display_passenger_info(string FName, string LName, string PhoneNum, int PID, int ROW, char COL) { 
